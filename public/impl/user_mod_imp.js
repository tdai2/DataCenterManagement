...
/* 
	[Bug 189714] - 
Commented to enable password editing for anonymouse user ::
...
function OnCheckRole()
{
    ...
    if(WEBVAR_JSONVAR_GET_ROLE.WEBVAR_STRUCTNAME_GET_ROLE[0]['CURUSERNAME'] == userName.value)
    {
        selectEnableDisable.disabled = true;
    }
    else
    {
        selectEnableDisable.disabled = false;
    }
}
//-------------------------------------//
...
function IPMICMD_HL_ModUser()
	...
	//Palan - Commenting the following lines as the anonymous user's passworld is also changeable.
	
	//if(userName.value=='anonymous')
	//{
		//RPC_ModUser.add("WEBVAR_PASSWD","");
	...
	RPC_ModUser.add("WEBVAR_USERENABLEDISABLE",selectEnableDisable.value);
